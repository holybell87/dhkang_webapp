    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/resources/index2.html" class="logo">
          ...
          <span class="logo-lg"><b>dhkang</b> WEB</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/resources/dist/img/default_profile.png" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">${login.uid}</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="/resources/dist/img/default_profile.png" class="img-circle" alt="User Image" />
                    <p>
                      ${login.uname} - Client
                      <small>Member since <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${login.regdate}" /></small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
